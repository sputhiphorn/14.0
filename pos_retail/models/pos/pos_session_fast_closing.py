            ...
            BEGIN
              ...
              LOOP
                ...
                LOOP
                  ...
                  INSERT INTO "account_move_line" ("id", "ref", "date", "journal_id", "payment_id", "name", "tax_exigible", "reconciled", "statement_id", "currency_id", "credit", "date_maturity", "debit", "amount_currency", "blocked", "partner_id", "move_id", "account_id", "create_uid", "write_uid", "create_date", "write_date") VALUES(
                  ...
                  INSERT INTO "account_move_line" ("id", "ref", "date", "journal_id", "payment_id", "statement_id", "tax_exigible", "reconciled", "account_id", "currency_id", "credit", "date_maturity", "debit", "amount_currency", "blocked", "partner_id", "move_id", "name", "create_uid", "write_uid", "create_date", "write_date") VALUES(
                    nextval('account_move_line_id_seq'),
                    abs.name,
                    (now() at time zone 'UTC'),  
                    abs.journal_id,
