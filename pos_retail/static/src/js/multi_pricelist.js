odoo.define('pos_retail.multi_pricelist', function (require) {
            ...
            if (id) {
                ...
                if ((journal_selected && order_selected.currency && journal_selected.currency_id && journal_selected.currency_id[0] != order_selected.currency.id) || !journal_selected.currency_id) {
                    return this.pos.gui.show_popup('dialog', {
                        title: 'Error',
                        body: 'Not allow add  Payment Method have differene Journal Currency with your selected Pricelist (or pos config) Currency'
                    })
                }
            }
    ...
    models.Product = models.Product.extend({
        get_price: function (pricelist, quantity) {
            ...
            console.log('Product id: ' + this.id + ' with pricelist: ' + pricelist.name + ' with price: ' + price);
            return price;
        },
    });
