odoo.define('pos_extend.popups', function (require) {
    ...
    var popup_select_variants = PopupWidget.extend({
        ...
        show: function (options) {
            ...
            this.$('.confirm').click(function () {
                ...
                selected_line.price_manually_set = false;
                self.pos.gui.close_popup();
            });
            this.$('.cancel').click(function () {
                self.pos.gui.close_popup();
            ...
            this.$('.remove_variants_selected').click(function () {
                ...
                if (!selected_orderline) {
                    ...
                    selected_orderline['variants'] = [];
                    selected_orderline.set_unit_price(selected_orderline.price);
                    selected_orderline.price_manually_set = false;
                }
                self.pos.gui.close_popup();
                self.pos.gui.show_popup('dialog', {
                    title: 'Succeed',
